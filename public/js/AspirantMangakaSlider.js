...
$(document).ready(function(){
    $('.list-test').owlCarousel({
        ...
        touchDrag  : false,
        mouseDrag  : false,
        navText : ["<i class='fa fa-chevron-left slider3'></i>","<i class='fa fa-chevron-right slider3'></i>"],
        ...
        navClass:["owl-prev3" , "owl-next3"],
         ...
         $(document).ready(function () {
            ...
            owl.owlCarousel({
              ...
              loop: true,
              dots: true,
              navText : ["<span class='opacity-div2 aspirant-opacity-div2'><i class='fa fa-chevron-left slider3'></i></span>","<span class='opacity-div1'><i class='fa fa-chevron-right slider3'></i></span>"],
              navClass:["owl-prev3" , "owl-next3"],
              responsive: {
                0: {
                  items: 1
